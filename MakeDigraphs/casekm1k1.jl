...
\\end{tikzpicture}}
\\caption{Digraph of cyclic permutation~\\cref{eq:valid3km1k1-}, in setting \$(k-1,k-1,k+1)\$.}
...
ctr = 1
for perm in perms
	savFile = joinpath(dirname(@__FILE__),"digraph-valid3km1k1-$(ctr).tex")
	pth = "\n"
	for idx in spots
	...
	digtex = replace(replace(digstr,"<INSERT PATH HERE>",pth),":valid3km1k1-",":valid3km1k1-$(ctr)")
	...
	permtex = replace(replace(permstr,"<INSERT PERM HERE>",pth),":valid3km1k1-",":valid3km1k1-$(ctr)")
	println(permtex)
	println("\n")
